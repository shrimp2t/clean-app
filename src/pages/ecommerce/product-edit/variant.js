...
import { Input, TreeSelect, Select, Button, Upload, Icon, Form } from 'antd';
      ...
      <div className="row">
        <div className="col-lg-8">
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="form-group">
                <FormItem label="SKU">{form.getFieldDecorator('sku')(<Input placeholder="Product SKU" />)}</FormItem>
              </div>
            </div>
            <div className="col-lg-12">
              ...
              <div className="form-group">
                <FormItem label="Full description">
                  {form.getFieldDecorator('fullDescription')(<TextArea rows={3} id="product-edit-fulldescr" />)}
                </FormItem>
              </div>
